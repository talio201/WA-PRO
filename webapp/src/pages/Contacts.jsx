...
export default function Contacts() {
  ...
  return (
    <div className="flex flex-col flex-1 h-full w-full min-h-0 bg-slate-900 text-slate-200 p-4 md:p-6 gap-6 rounded-2xl relative overflow-hidden">
      
      {/* HEADER COMPLETO RICH AESTHETICS */}
      <div className="flex flex-col xl:flex-row items-start justify-between gap-4 md:gap-6 bg-slate-800/60 p-4 md:p-6 lg:px-8 rounded-3xl border border-slate-700/50 shadow-[0_8px_30px_rgb(0,0,0,0.12)] backdrop-blur-md relative w-full shrink-0 min-h-[112px]">
        ...
        <div className="flex flex-col sm:flex-row items-start gap-4 z-10 w-full">
          ...
          <div className="flex flex-col flex-1 min-w-0">
            ...
            <div className="flex items-center gap-2 mt-1.5 opacity-80">
               ...
               <p className="text-sm tracking-wide text-slate-300">Agenda Pessoal Segura</p>
            </div>
              <p className="text-sm text-slate-400 mt-1 leading-relaxed break-words">Gerencie os contatos isolados deste navegador. Nenhuma outra máquina tem acesso a esses dados.</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-3 w-full">
        {(leadAnalytics ? [
          ...
          <div key={item.key || idx} className="rounded-2xl border border-slate-700/50 bg-slate-800/50 px-4 py-3 min-h-[72px] flex flex-col justify-center">
            {item.skeleton ? (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 w-full max-w-full">
        ...
        <div className="lg:col-span-2 bg-slate-800/40 rounded-3xl border border-slate-700/50 shadow-lg flex flex-col overflow-hidden backdrop-blur-sm min-w-0 w-full">
